exp_name = 'edvr_g8_600k_large_wopre_finetune_compress3'
...
model = dict(
    ...
    generator=dict(
        ...
        with_predeblur=True,
        with_tsa=True),
    pixel_loss=dict(type='CharbonnierLoss', loss_weight=8.0, reduction='sum'))
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file=
            './data/video_compress_track3/test_youtube/images/meta_info_Compress_min_extra_test.txt',
            num_input_frames=5,
...
load_from = './work_dirs/edvr_g8_600k_large_wopre_compress3/iter_300000.pth'
# load_from = None
resume_from = None
workflow = [('train', 1)]
